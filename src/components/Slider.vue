...
@media screen and (max-width:414px) {
  ...
  <template>
    <div class='slider-container' :class='basicdata.containerClass'>
        <div class="slider-wrapper" :style="styleobj" @touchmove="swipeMove" @touchstart="swipeStart" @touchend="swipeEnd" @mousedown="swipeStart" @mouseup="swipeEnd" @mousemove="swipeMove" @webkitTransitionEnd="onTransitionEnd" @transitionend="onTransitionEnd">
            <!-- 正常滚动 -->
...
<script>
import detectPrefixes from 'src/utils/detect-prefixes.js';
export default {
