<template>
  <div class="tab-content">
      ...
      <ul class="line-list">
        ...
        <!-- <li><span class="name">会员性别：</span>男</li> -->
        ...
        <li><span class="name">出生日期：</span>1982/09/10</li>
